...
let mealCall = function(city, state, time) {
  ...
  let clientInfo =
    "client_id=3N2N3WZK5ZGFFORDLOQ2PISXVJG1UI5VPYZFFPJY2BD1U1G1&client_secret=QXZWHCJJLB21N2WI1YFUWELH1SULPYKKRKKQSEOCAUXA2ZON";
  //  Use args to generate queryURL, and make API call
  let mealQuery =
    endpoint +
    clientInfo +
    "&v=20180323&categoryId=4d4b7105d754a06374d81259&near=" +
    city +
    "," +
    state +
    "&time=" +
...
let eventCall = function(city, state, time, timeSlot) {
  ...
  switch (timeSlot) {
    ...
    case "dinner":
      eventQuery +=
        "&categoryId=4d4b7105d754a06377d81259,4d4b7104d754a06370d81259";
      break;
    case "late night":
